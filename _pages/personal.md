...
![MLS Hoodie IRL Front]({{ "/assets/images/mls-hoodie-front.jpeg" | relative_url }}){: .inline-image-1 style="width: 200px"}
![MLS Hoodie IRL Back]({{ "/assets/images/mls-hoodie-back.jpeg" | relative_url }}){: .inline-image-1 style="width: 200px"}
...
Found and adjusted the size and printing conditions for this floating dragon for a friend of mine who loves the Fourth Wing book series. As you can see, there are 3 pieces that, when put together, make the dragon float and "breath fire" onto the books when the stand on the opposite side of the fire from the dragon is placed in between the books. The main character has two dragons of varying sizes so I printed a large black one and a smaller gold one. Once all the parts were printed I applied some glue to the connections between them and used clamps to hold them together while they dried.
...
These masks are just a passion of mine. I like to print masks from tv shows and movies that look intriguing. I printed the Tengu mask (the one with the long nose) and realized I did not have a good way to mount it once it was created so I was stumped. It was actually at an internship while working with mangnets that I realized this could be a solution to my problem. Speaking with some poeple there who did lots of 3D printing; I found out that you can actually start a print with a void, pause it, embed magnets, and then continue the print. Applying this to my masks, I can find small magnets, embed them in the edges of the mask, and when this is done: I would have the full mask with magnets at specific positions. Then, I can just stick magnets on the wall, making sure they are opposite the ones in the print, and I'll have masks that seemingly stick to the wall by magic!
